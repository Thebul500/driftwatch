...
os.environ.setdefault("DRIFTWATCH_DATABASE_URL", "sqlite+aiosqlite:///")
...
os.environ.setdefault("DRIFTWATCH_TEST_WRONG_PASSWORD", "wrongpassword123")
os.environ.setdefault("DRIFTWATCH_TEST_SHORT_PASSWORD", "short")
